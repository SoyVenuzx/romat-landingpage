...
export default function ServicesInteractive({
	...
	const [activeCategory, setActiveCategory] =
		useState<ServiceCategory>("Consultas");
	...
	return (
		<>
			<div
				className="mb-8 motion-safe:animate-fade-up motion-safe:opacity-0 motion-reduce:animate-none motion-reduce:opacity-100"
