...
export const clinicTrustPillars = [
	{
		...
		description:
			"Disponibilidad diferenciada entre semana y fines de semana para mayor flexibilidad.",
	},
	{
		id: "domicilio",
		title: "Consultas a domicilio",
		description:
			"Servicio agendado para valoraciones médicas en casa con enfoque humano y seguro.",
	},
	{
		id: "pagos",
		title: "Métodos de pago",
		description:
			"Alternativas cómodas y seguras para completar tu atención en clínica o laboratorio.",
	},
];
